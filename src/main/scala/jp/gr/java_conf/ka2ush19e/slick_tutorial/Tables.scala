...
// A jp.gr.java_conf.ka2ush19e.slick_tutorial.Suppliers table with 6 columns: id, name, street, city, state, zip
...
// A jp.gr.java_conf.ka2ush19e.slick_tutorial.Coffees table with 5 columns: name, supplier id, price, sales, total
